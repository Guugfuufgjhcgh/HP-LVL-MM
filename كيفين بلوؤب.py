...
TOKEN = "7143755185:AAFDsdYd-zqXm_nn1gfIpYJeRmyHZb1pEVE"
...
def send_welcome(message):
    welcome_message = """
اهلا بك في مقبرة HP LVL. يرجى كتابة -- قبل أي ايدي وسوف يتم وضعه في المقبرة.
    /start --Player ID
    مثال:
    /start --1234567890
    """
...
def get_player_info(message):
    if '--' in message.text:
        ...
        if response.status_code == 200:
            ...
            bot.reply_to(message, "تم وضع هذا العب في المقبرة بنجاح ")
    else:
